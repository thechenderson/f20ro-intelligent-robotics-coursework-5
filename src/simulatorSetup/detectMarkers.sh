...
gnome-terminal -- /bin/bash -c "./../detect_markers/build/detect_markers"
gnome-terminal -- /bin/bash -c "yarpview --name /view/detect_markers; exec bash"
sleep 2
gnome-terminal -- /bin/bash -c "yarp connect /webcam/video /imageProc/image/in;"
sleep 2
gnome-terminal -- /bin/bash -c "yarp connect /imageProc/image/out /view/detect_markers;"